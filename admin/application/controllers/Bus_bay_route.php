...
class Bus_bay_route extends CI_Controller {

    function __construct() {
        parent::__construct();
        $this->aauth->control();
        $this->load->model('Bus_bay_route_model', 'model');
    ...
    public function index() {
        ...
        $this->load->view('Bus_bay_route', $form_data);
    ...
    private function get_header_data() {
        ...
        $data['title'] = 'Manage Bay to Route';
    ...
    private function get_form_data() {
		...
		$data['bay_id'] = $this->model->getBayid();
    ...
    public function save() {
        ...
        $this->form_validation->set_rules('bay_id', 'Bay Id', 'trim');
