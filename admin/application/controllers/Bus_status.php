...
class Bus_status extends CI_Controller {
    ...
    function __construct() {
        parent::__construct();
        $this->aauth->control();
        $this->load->model('Bus_staus_model', 'model');
    ...
    public function index() {
        ...
        $this->load->view('Bus_status', $form_data);
    ...
    public function save() {
        ...
        $this->form_validation->set_rules('status_name', 'Status Name', 'trim');
		
        $this->form_validation->set_rules('status_name_si', 'Status Name Si', 'trim');
		
        $this->form_validation->set_rules('status_name_ta', 'Status Name Ta', 'trim');
