...
class Corp_division extends CI_Controller {

    function __construct() {
        parent::__construct();
        $this->aauth->control();
        $this->load->model('Corp_division_m', 'model');
    ...
    public function index() {
        ...
        $this->load->view('admin/corp_division_view', $form_data);
    ...
    private function get_header_data() {
        ...
        $data['title'] = 'Corporation Divisions';
    ...
    public function save() {
        ...
        $this->form_validation->set_rules('division_code', 'Division code', 'trim');
