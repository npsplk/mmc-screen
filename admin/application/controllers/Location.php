...
class Location extends CI_Controller {
    ...
    public function index() {
        ...
        $this->load->view('admin/Location', $form_data);
    ...
    private function get_form_data() {
        $data = array();
		$data['route_id'] = $this->model->getRouteid();;$data['location_id'] = $this->model->getLocationid();;$data['week_day_id'] = $this->model->getWeekdayid();;$data['route_id'] = $this->model->getRouteid();
        return $data;
    }
    ...
    public function save() {
        ...
        $this->form_validation->set_rules('location_name', 'Location Name', 'trim');
		
        $this->form_validation->set_rules('location_name_si', 'Location Name Si', 'trim');
		
        $this->form_validation->set_rules('location_name_ta', 'Location Name Ta', 'trim');
