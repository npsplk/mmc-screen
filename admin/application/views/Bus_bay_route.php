<body class="form-page">
   ...
   <div class="main-container">
      <div class="container">
         ...
         <i class="fa fa-list-alt" aria-hidden="true"></i> Set Bay to Route
         </button>
         <div class="row">
            <div class="form-content-div collapse" id="form_cont">
               <form class="form-horizontal"  id="bus_bay_route_form" name="bus_bay_route_form">
                  <input id="id" name="id" class="form-control input-md" type="hidden">
                  <div class="form-area">
                  </div>
                  <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                     <div class="form-group">
                        <label class="col-md-4 control-label" for="bay_id">Bay<span class="required-field"> *</span></label>  
                        <div class="col-md-8 validate-parent">
                           <?php
                              echo form_dropdown('bay_id" id="bay_id" required class="form-control text-left"', $bay_id, 0);
                              ?> 
                        </div>
                     </div>
                     <div class="form-group">
                        <label class="col-md-4 control-label" for="route_id">Route<span class="required-field"> *</span></label>  
                        <div class="col-md-8 validate-parent">
                           <?php
