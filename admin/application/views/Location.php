    ...
    <div class="main-container">            
        <div class="container">
            ...
            <button class="btn btn-default" type="button" data-toggle="collapse" data-target="#form_cont" aria-expanded="false" aria-controls="collapseExample">
                <i class="fa fa-list-alt" aria-hidden="true"></i> Add location
            </button>
            <div class="row">
                <div class="form-content-div collapse" id="form_cont">
                    <form class="form-horizontal"  id="location_form" name="location_form">
                        <input id="id" name="id" class="form-control input-md" type="hidden">
                        <div class="form-area">
								</div>
								<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12"> 
									<div class="form-group">
										<label class="col-md-4 control-label" for="location_name">Location Name</label>  
										<div class="col-md-8 validate-parent">
											<input id="location_name" name="location_name" class="form-control input-md" type="text" maxlength="100">
										</div>
									</div> 
									<div class="form-group">
										<label class="col-md-4 control-label" for="location_name_si">Location Name Si</label>  
										<div class="col-md-8 validate-parent">
											<input id="location_name_si" name="location_name_si" class="form-control input-md" type="text" maxlength="100">
										</div>
									</div> 
								</div>
								<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12"> 
									<div class="form-group">
										<label class="col-md-4 control-label" for="location_name_ta">Location Name Ta</label>  
										<div class="col-md-8 validate-parent">
											<input id="location_name_ta" name="location_name_ta" class="form-control input-md" type="text" maxlength="100">
										</div>
									</div> 
									<div class="form-group">
                ...
                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                    <table class="table table-hover" id="data_grid_table"> 
                        <thead> 
                            <tr>
                                <th>Location Name</th>
                                <th>Location Name Si</th>
                                <th>Location Name Ta</th>
                                <th>Remarks</th>
                                <th>Status</th>
