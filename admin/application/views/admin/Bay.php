                    ...
                    <form class="form-horizontal"  id="bay_form" name="bay_form">
                        ...
                        <div class="form-area">
								...
								<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12"> 
									...
									<div class="form-group">
										<label class="col-md-4 control-label" for="assigned_route">Assigned Route</label>  
										<div class="col-md-8 validate-parent">
											<input id="assigned_route" name="assigned_route" class="form-control input-md" type="text" maxlength="100">
										</div>
									</div> 
								</div>
								<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12"> 
