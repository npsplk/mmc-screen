                    ...
                    <form class="form-horizontal"  id="route_form" name="route_form">
                        ...
                        <div class="form-area">
								...
								<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12"> 
									...
									<div class="form-group">
										<label class="col-md-4 control-label" for="from_location_si">From Location Si</label>  
										<div class="col-md-8 validate-parent">
								...
								<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12"> 
									<div class="form-group">
										<label class="col-md-4 control-label" for="to_location_si">To Location Si</label>  
										<div class="col-md-8 validate-parent">
											<input id="to_location_si" name="to_location_si" class="form-control input-md" type="text" maxlength="100">
										</div>
									</div> 
									<div class="form-group">
										<label class="col-md-4 control-label" for="from_location_ta">From Location Ta</label>  
										<div class="col-md-8 validate-parent">
								...
								<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12"> 
									<div class="form-group">
										<label class="col-md-4 control-label" for="to_location_ta">To Location Ta</label>  
										<div class="col-md-8 validate-parent">
                    ...
                    <table class="table table-hover" id="data_grid_table"> 
                        <thead> 
                            <tr>
                                ...
                                <th>From Location</th>
                                <th>To Location</th>
                                <th>From Location Si</th>
                                <th>To Location Si</th>
                                <th>From Location Ta</th>
                                <th>To Location Ta</th>
                                <th>Created Date</th>
                                <th>Last Updated</th>
                                <th>Updated By</th>
                                <th>Remark</th>
