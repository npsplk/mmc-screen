...
js(document).ready(function () {
        ...
        var user_detail = js('#user_name_for_detail').val();
...
//    alert();
    ...
    js.post("user_profile/load_personal_profile", {user_detail: user_detail}, function (e) {
...
//    alert();
    var unknown = js('#unknown').val();
    js.post("user_profile/load_member_profile", {user_detail: user_detail}, function (e) {
        if (e === undefined || e.length === 0 || e === null || e.status == 2) {
...
//    alert();
    var unknown = js('#unknown').val();
    js.post("user_profile/load_member_qualification_profile", {user_detail: user_detail}, function (e) {
        if (e === undefined || e.length === 0 || e === null || e.status == 2) {
...
//    alert();
    var unknown = js('#unknown').val();
    js.post("user_profile/load_personal_qualification_profile", {user_detail: user_detail}, function (e) {
