...
<head>
    ...
    <title>Bus Schedule Summary</title>
...
<?php
include_once("model/all_destination.php");
?>
<body>
    ...
    <div class="slider-content">
        <div>
            <table class="table table-hover">
                <thead>
                <tr>
                    <th><span class="heading hide-icon">Icon</span></th>
                    <th><span class="heading">TIME</span></th>
                    <th><span class="heading">DESTINATION</span></th>
                    <th><span class="heading">ROUTE NUMBER</span></th>
                    <th><span class="heading">BAY NUMBER</span></th>
                ...
                if (count($result_schedule['screenRows']) > 0) {
                    foreach ($result_schedule['screenRows'] as $row) {
                        ...
                        ?>
                        <tr>
                            <td><span class="icon"><i class="<?php echo $class_name; ?>"></i></span></td>
                            <td>
                                <span class="time"><?php echo $row['time']; ?> </span>
                            </td>
                            <td><span class="destination"><?php echo $row['destination'][0]; ?> </span></td>
                            <td><span class="route"><?php echo $route; ?> </span></td>
                    ...
                    <tr>
                        <td colspan="6">No scheduled journey on this route. </td>
        ...
        <div>
            <table class="table table-hover">
                <thead>
                <tr>
                    <th><span class="heading hide-icon"></span></th>
                    <th><span class="heading">වේලාව</span></th>
                    <th><span class="heading">ගමනාන්තය</span></th>
                    <th><span class="heading">මාර්ග අංකය</span></th>
                ...
                if (count($result_schedule) > 0) {
                    ...
                    <tr>
                        <td colspan="6">අද දින සඳහා නියමිත ගමන්වාර නොමැත.</td>
        ...
        <div>
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <th><span class="heading">பாதை</span></th>
                ...
                if (count($result_schedule) > 0) {
                    ...
                    <tr>
                        <td colspan="6">இன்று திட்டமிடப்பட்ட விமானங்கள் இல்லை</td>
